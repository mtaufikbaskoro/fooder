...
<div class="transaction-view">
    ...
    <p>
        <?php  // Html::a('Update', ['update', 'id_transaction' => $model->id_transaction], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('<i class="fa fa-trash-o" aria-hidden="true"></i>', ['delete', 'id_transaction' => $model->id_transaction], [
